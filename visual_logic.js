...
operateAnimation('STOP', 'Cube', null, null, 'AUTO', 1, function() {}, false);
operateAnimation('STOP', 'Sphere', null, null, 'AUTO', 1, function() {}, false);

animar = 'ON';
registerOnClick('Sphere', false, false, [0,1,2], false, function(event) {
    if (animar == 'ON') {
        operateAnimation('PLAY', 'Cube', 0, 30, 'LoopOnce', 1, function() {
            animar = 'OFF';
        }, false);
    } else {
        operateAnimation('PAUSE', 'Cube', null, null, 'AUTO', 1, function() {}, false);
        operateAnimation('PLAY', 'Cube', 0, 30, 'LoopOnce', 1, function() {
            animar = 'ON';
        }, true);
    }
...
registerOnClick('Sphere', false, false, [0,1,2], false, function(event) {
    if (animar == 'ON') {
        operateAnimation('PLAY', 'Sphere', 0, 30, 'LoopOnce', 1, function() {
            animar = 'OFF';
        }, false);
    } else {
        operateAnimation('PLAY', 'Sphere', 0, 30, 'LoopOnce', 1, function() {
